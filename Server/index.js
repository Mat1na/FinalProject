...
app.delete("/authors/:_id", (req, res) => {
  ...
  Author.findByIdAndDelete(_id).then((result) => {
    res.json({
      message: "deleted",
      data: result,
    });
...
app.delete("/projects/:_id", (req, res) => {
  const { _id } = req.params; //get id
  Project.findByIdAndDelete(_id).then((result) => {
    res.json({
      message: "deleted",
      data: result,
    });
...
app.delete("/labmembers/:_id", (req, res) => {
  const { _id } = req.params; //get id
  Profile.findByIdAndDelete(_id).then((result) => {
    res.json({
      message: "deleted",
      data: result,
    });
...
app.delete("/publications/:_id", (req, res) => {
  const { _id } = req.params; //get id
  Publication.findByIdAndDelete(_id).then((result) => {
    res.json({
      message: "deleted",
      data: result,
    });
