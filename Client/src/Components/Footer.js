      ...
      <footer>
        ...
        <div className='d-block footer-icon-list'>
          <ul className="nav justify-content-center list-unstyled d-flex">
            <li className="mx-3"><a className="footerlink" href={`mailto:koenraad.vanmeerbeek@kuleuven.be`}><GoMail size={"2.5rem"} className="icons footer-icons me-1" /></a></li>
            <li className="mx-3"><a className="footerlink" href="tel:+32%2016%20377444%20"><BsTelephoneFill size={"2.5rem"} className="footer-icons icons me-1" /></a></li>
            <li className="mx-3"><a className="footerlink" href="https://twitter.com/K_VanMeerbeek" target="_blank" rel="noreferrer"><FaTwitter size={"2.5rem"} className="footer-icons icons me-1" /></a></li>
