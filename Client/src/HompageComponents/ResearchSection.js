...
function ResearchSection({ width, height, src, alt, ...rest }) {
      ...
      <Row className="d-flex align-items-center justify-content-center mx-4 ">
        ...
        <Col lg={6} >
          <Row className='d-flex align-items-center justify-content-center'>
            <h3 className={`text-center ${myRef1IsVisible ? "divMove" : ""}`} ref={myRef1}>Topics</h3>
            <Col sm={5} className='row-research research-photo '>
              <div className={`research-photo-container ${myRef1IsVisible ? "divMove" : ""}`} ref={myRef1}>
                {myImgIsVisible || supportsLazyLoading ? (
                  <img src="/MicroclimateEcology.jpg" className='jpg-research d-flex' alt='Microclimate ecology' loading="lazy" {...rest}/>
                ) : null}
                <div ref={myImg} data-inview={myImgIsVisible} className="research-photo-container-overlay"></div>
              </div>
            </Col>
            ...
            <Col sm={5} className='row-research research-photo'>
              <div className={`research-photo-container ${myRef2IsVisible ? "divMove" : ""}`} ref={myRef2}>
                {myImgIsVisible || supportsLazyLoading ? (
                  <img src="/GlobalChangeEffects.jpg" className='jpg-research d-flex' alt='Global change effects' loading="lazy" {...rest}/>
                ) : null}
            ...
            <Col sm={5} className='row-research research-photo'>
              <div className={`research-photo-container ${myRef3IsVisible ? "divMove" : ""}`} ref={myRef3}>
                ...
                {myImgIsVisible || supportsLazyLoading ? (
                  <img src="/BiodiversityConservation.jpg" className='jpg-research d-flex' alt='Biodiversity conservation'    loading="lazy" 
                  {...rest}/>
                ) : null}
                <div ref={myImg} data-inview={myImgIsVisible} className="research-photo-container-overlay"></div>
              </div>
        ...
        <Col lg={6}>
          <Row className='d-flex align-items-center justify-content-center '>
            <h3 className={`text-center  ${myRef1IsVisible ? "divMove1" : ""}`} ref={myRef1}>Methods</h3>
            <Col sm={5} className='row-research research-photo'>
              <div className={`research-photo-container ${myRef4IsVisible ? "divMove1" : ""}`} ref={myRef4}>
                {myImgIsVisible || supportsLazyLoading ? (
                  <img src="/Ecoinformatics.jpg" className='jpg-research d-flex' alt='Ecoinformatics'loading="lazy" {...rest} />
                ) : null}
                <div ref={myImg} data-inview={myImgIsVisible} className="research-photo-container-overlay"></div>
              </div>
            </Col>
            ...
            <Col sm={5} className='row-research research-photo'>
              <div className={`research-photo-container ${myRef5IsVisible ? "divMove1" : ""}`} ref={myRef5}>
                ...
                {myImgIsVisible || supportsLazyLoading ? (
                  <img src="/FieldWork.jpg" className='jpg-research d-flex' alt='Field work'loading="lazy" {...rest} />
                ) : null}
                <div ref={myImg} data-inview={myImgIsVisible} className="research-photo-container-overlay"></div>
              </div>
            </Col>
            ...
            <Col sm={5} className='row-research research-photo'>
              <div className={`research-photo-container ${myRef6IsVisible ? "divMove1" : ""}`} ref={myRef6}>
                ...
                {myImgIsVisible || supportsLazyLoading ? (
                  <img src="/Drones.jpg" className='jpg-research d-flex' alt='Drones' loading="lazy" {...rest}/>
                ) : null}
                <div ref={myImg} data-inview={myImgIsVisible} className="research-photo-container-overlay"></div>
              </div>
            </Col>
