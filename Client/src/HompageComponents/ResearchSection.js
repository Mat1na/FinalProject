...
function ResearchSection() {
  ...
  return (
    <Container fluid className='mb-0 mt-0'>
      ...
      <Row className="d-flex align-items-center justify-content-center mx-0 gx-">
        <Col lg={6} >
          <Row className='d-flex align-items-center justify-content-center'>
            <h3 className={`text-center topics-methods mb-0 mb-xxl-3 ${myRef1IsVisible ? "divMove" : ""}`} ref={myRef1}>Topics</h3>
        ...
        <Col lg={6}>
          <Row className='d-flex align-items-center justify-content-center'>
            <h3 className={`text-center mb-0 topics-methods mb-xxl-3 ${myRef4IsVisible ? "divMove1" : ""}`} ref={myRef4}>Methods</h3>
            <Col sm={5} className='row-research research-photo'>
