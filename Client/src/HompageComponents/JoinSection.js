    ...
    return (<>
        ...
        <Container fluid className='mt-0'>
            ...
            <div className={`join-bg ${myJoin2IsVisible ? "divslide2" : ""}`} ref={myJoin2}>
                ...
                <h4 className="montserrat join-titles">Funding opportunities for PhD students</h4>
                ...
                <h4 className="montserrat join-titles">Funding opportunities for Postdocs</h4>
                <ul className='roboto paragraphtext'>
                ...
                <h2 className="montserrat join-titles">Why choose KU Leuven?</h2>
